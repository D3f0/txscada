...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'AI.rel_33_13'
        db.delete_column('mara_ai', 'rel33-13')


    def backwards(self, orm):
        # Adding field 'AI.rel_33_13'
        db.add_column('mara_ai', 'rel_33_13',
                      self.gf('django.db.models.fields.FloatField')(default=1, db_column='rel33-13'),
                      keep_default=False)
