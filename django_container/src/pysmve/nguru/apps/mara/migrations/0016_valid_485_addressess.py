...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        COMaster = orm['mara.COMaster']
        COMaster.objects.filter(rs485_source=0).update(rs485_source=64)
        COMaster.objects.filter(rs485_destination=0).update(rs485_source=1)
    ...
    models = {
        ...
        'mara.ai': {
            ...
            'peso_p': ('django.db.models.fields.FloatField', [], {'default': '1'}),
