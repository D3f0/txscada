...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'NotificationRequest.object_id'
        db.alter_column('notifications_notificationrequest', 'object_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'NotificationRequest.content_type'
        db.alter_column('notifications_notificationrequest', 'content_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'], null=True))

    def backwards(self, orm):

        # Changing field 'NotificationRequest.object_id'
        db.alter_column('notifications_notificationrequest', 'object_id', self.gf('django.db.models.fields.PositiveIntegerField')(default=None))

        # Changing field 'NotificationRequest.content_type'
        db.alter_column('notifications_notificationrequest', 'content_type_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['contenttypes.ContentType']))
    ...
    models = {
        ...
        'notifications.emailnotificationassociation': {
            ...
            'subject': ('django.db.models.fields.TextField', [], {'default': "'Alerta SMVE'"}),
            'targets': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['auth.User']", 'symmetrical': 'False'}),
            'template': ('django.db.models.fields.TextField', [], {'default': "'Estimado\\nSe ha producido un evento {{ event }} en {{ event.di.ied.co_master.description }} a las {{ event.timestamp|date:config.EVENT_DATE_FORMAT }}'"})
        },
        'notifications.messagelogeventrelation': {
            'Meta': {'object_name': 'MessageLogEventRelation'},
            'event': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'related_emails'", 'to': "orm['mara.Event']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'message': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'related_events'", 'to': "orm['mailer.Message']"})
        },
        ...
        'notifications.smsnotificationassociation': {
            ...
            'targets': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['auth.User']", 'symmetrical': 'False'}),
            'template': ('django.db.models.fields.TextField', [], {'default': "'{{ event }} {{ timestamp|date:config.EVENT_DATE_FORMAT }}'"})
        }
    }
