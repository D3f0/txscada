...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EmailNotificationAssociation.subject'
        db.add_column('notifications_emailnotificationassociation', 'subject',
                      self.gf('django.db.models.fields.TextField')(default='Alerta SMVE'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EmailNotificationAssociation.subject'
        db.delete_column('notifications_emailnotificationassociation', 'subject')
