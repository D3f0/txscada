...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SVGElement.linked_text_change'
        db.alter_column('hmi_svgelement', 'linked_text_change', self.gf('django.db.models.fields.CharField')(max_length=120, null=True))

    def backwards(self, orm):

        # Changing field 'SVGElement.linked_text_change'
        db.alter_column('hmi_svgelement', 'linked_text_change', self.gf('django.db.models.fields.CharField')(max_length=12, null=True))
