...
class Migration(DataMigration):
    ...
    new_text = 'ES (En Servicio), FS (Fuera de Servicio)'
    def forwards(self, orm):
        ...
        SVGElement.objects.filter(text__iexact='ES').update(text=self.new_text)
        SVGElement.objects.filter(text__iexact='FS').update(text=self.new_text)
    ...
    def backwards(self, orm):
        ...
        SVGElement.objects.filter(text__iexact=self.new_text).update(text='FS')
