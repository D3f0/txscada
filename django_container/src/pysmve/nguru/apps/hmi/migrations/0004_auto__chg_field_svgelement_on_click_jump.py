...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SVGElement.on_click_jump'
        db.alter_column('hmi_svgelement', 'on_click_jump_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['hmi.SVGScreen'], null=True))

    def backwards(self, orm):

        # Changing field 'SVGElement.on_click_jump'
        db.alter_column('hmi_svgelement', 'on_click_jump_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['hmi.SVGElement'], null=True))
