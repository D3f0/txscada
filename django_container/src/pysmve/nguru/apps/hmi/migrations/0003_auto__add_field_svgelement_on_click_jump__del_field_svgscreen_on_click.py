...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SVGElement.on_click_jump'
        db.add_column('hmi_svgelement', 'on_click_jump',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['hmi.SVGElement'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'SVGElement.on_click_jump'
        db.delete_column('hmi_svgelement', 'on_click_jump_id')
    ...
    models = {
        ...
        'hmi.svgelement': {
            ...
            'on_click_jump': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['hmi.SVGElement']", 'null': 'True', 'blank': 'True'}),
