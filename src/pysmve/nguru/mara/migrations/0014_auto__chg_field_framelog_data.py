...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FrameLog.data'
        db.alter_column('mara_framelog', 'data', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'FrameLog.data'
        db.alter_column('mara_framelog', 'data', self.gf('django.db.models.fields.TextField')(default=''))
