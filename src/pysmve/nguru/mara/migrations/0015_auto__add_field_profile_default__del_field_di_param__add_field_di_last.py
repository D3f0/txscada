...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.default'
        db.add_column('mara_profile', 'default',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'DI.param'
        db.delete_column('mara_di', 'param')

        # Adding field 'DI.last_update'
        db.add_column('mara_di', 'last_update',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'EnergyPoint.param'
        db.delete_column('mara_energypoint', 'param')

        # Adding field 'EnergyPoint.last_update'
        db.add_column('mara_energypoint', 'last_update',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'SV.param'
        db.delete_column('mara_sv', 'param')

        # Adding field 'SV.last_update'
        db.add_column('mara_sv', 'last_update',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'AI.param'
        db.delete_column('mara_ai', 'param')

        # Adding field 'AI.last_update'
        db.add_column('mara_ai', 'last_update',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.default'
        db.delete_column('mara_profile', 'default')

        # Adding field 'DI.param'
        db.add_column('mara_di', 'param',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'DI.last_update'
        db.delete_column('mara_di', 'last_update')

        # Adding field 'EnergyPoint.param'
        db.add_column('mara_energypoint', 'param',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'EnergyPoint.last_update'
        db.delete_column('mara_energypoint', 'last_update')

        # Adding field 'SV.param'
        db.add_column('mara_sv', 'param',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'SV.last_update'
        db.delete_column('mara_sv', 'last_update')

        # Adding field 'AI.param'
        db.add_column('mara_ai', 'param',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'AI.last_update'
        db.delete_column('mara_ai', 'last_update')
    ...
    models = {
        ...
        'mara.framelog': {
            'Meta': {'ordering': "('date',)", 'object_name': 'FrameLog'},
            'data': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'date': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'payload': ('jsonfield.fields.JSONField', [], {'null': 'True', 'blank': 'True'}),
            'profile': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'logs'", 'to': "orm['mara.Profile']"}),
