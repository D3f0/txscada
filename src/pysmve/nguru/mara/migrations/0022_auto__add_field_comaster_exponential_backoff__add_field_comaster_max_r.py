...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'COMaster.exponential_backoff'
        db.add_column('mara_comaster', 'exponential_backoff',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'COMaster.max_retry_before_offline'
        db.add_column('mara_comaster', 'max_retry_before_offline',
                      self.gf('django.db.models.fields.IntegerField')(default=3),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'COMaster.exponential_backoff'
        db.delete_column('mara_comaster', 'exponential_backoff')

        # Deleting field 'COMaster.max_retry_before_offline'
        db.delete_column('mara_comaster', 'max_retry_before_offline')
