...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'EventKind.text'
        db.delete_column('mara_eventkind', 'text')
        pk = orm.models['mara.profile'].objects.latest('pk').pk
        # Adding field 'EventKind.profile'
        db.add_column('mara_eventkind', 'profile',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=pk,
                              related_name='event_kinds',
                              to=orm['mara.Profile']),
                      keep_default=False)

        # Adding field 'EventKind.description'
        db.add_column('mara_eventkind', 'description',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)


        # Changing field 'EventKind.idtextoev2'
        db.alter_column('mara_eventkind', 'idtextoev2', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):
        # Adding field 'EventKind.text'
        db.add_column('mara_eventkind', 'text',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50),
                      keep_default=False)

        # Deleting field 'EventKind.profile'
        db.delete_column('mara_eventkind', 'profile_id')

        # Deleting field 'EventKind.description'
        db.delete_column('mara_eventkind', 'description')


        # Changing field 'EventKind.idtextoev2'
        db.alter_column('mara_eventkind', 'idtextoev2', self.gf('django.db.models.fields.IntegerField')(default=0))
