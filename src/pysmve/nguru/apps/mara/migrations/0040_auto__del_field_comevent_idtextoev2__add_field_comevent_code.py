...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ComEvent.code'
        db.add_column('eventcom', 'code',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'ComEvent.idtextoev2'
        raise RuntimeError("Cannot reverse this migration. 'ComEvent.idtextoev2' and its values cannot be restored.")
        # Deleting field 'ComEvent.code'
        db.delete_column('eventcom', 'code')
