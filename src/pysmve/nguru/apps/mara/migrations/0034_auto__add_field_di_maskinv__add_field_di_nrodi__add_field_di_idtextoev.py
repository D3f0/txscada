...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DI.maskinv'
        db.add_column('mara_di', 'maskinv',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'DI.nrodi'
        db.add_column('mara_di', 'nrodi',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'DI.idtextoev2'
        db.add_column('mara_di', 'idtextoev2',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'DI.persoaccinoh'
        db.add_column('mara_di', 'persoaccinoh',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'DI.pesoaccionl'
        db.add_column('mara_di', 'pesoaccionl',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DI.maskinv'
        db.delete_column('mara_di', 'maskinv')

        # Deleting field 'DI.nrodi'
        db.delete_column('mara_di', 'nrodi')

        # Deleting field 'DI.idtextoev2'
        db.delete_column('mara_di', 'idtextoev2')

        # Deleting field 'DI.persoaccinoh'
        db.delete_column('mara_di', 'persoaccinoh')

        # Deleting field 'DI.pesoaccionl'
        db.delete_column('mara_di', 'pesoaccionl')
