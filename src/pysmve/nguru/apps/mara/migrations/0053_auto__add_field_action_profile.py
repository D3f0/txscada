...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Action.profile'
        db.add_column('mara_action', 'profile',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['mara.Profile']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Action.profile'
        db.delete_column('mara_action', 'profile_id')
