...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('mara_di', 'param', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'SV.param'
        db.alter_column('mara_sv', 'param', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'AI.param'
        db.alter_column('mara_ai', 'param', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
