...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ComEvent.kind'
        db.delete_column('eventcom', 'kind_id')

        # Adding field 'ComEvent.idtextoev2'
        db.add_column('eventcom', 'idtextoev2',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'ComEventKind.description'
        db.delete_column('com', 'description')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'ComEvent.kind'
        raise RuntimeError("Cannot reverse this migration. 'ComEvent.kind' and its values cannot be restored.")
        # Deleting field 'ComEvent.idtextoev2'
        db.delete_column('eventcom', 'idtextoev2')


        # User chose to not deal with backwards NULL issues for 'ComEventKind.description'
        raise RuntimeError("Cannot reverse this migration. 'ComEventKind.description' and its values cannot be restored.")
