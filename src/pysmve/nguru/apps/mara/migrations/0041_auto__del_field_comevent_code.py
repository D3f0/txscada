...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'ComEvent.code'
        raise RuntimeError("Cannot reverse this migration. 'ComEvent.code' and its values cannot be restored.")
