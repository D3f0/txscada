...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.timestamp_ack'
        db.add_column('mara_event', 'timestamp_ack',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'SV.bit'
        db.alter_column('mara_sv', 'bit', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):
        # Deleting field 'Event.timestamp_ack'
        db.delete_column('mara_event', 'timestamp_ack')


        # Changing field 'SV.bit'
        db.alter_column('mara_sv', 'bit', self.gf('django.db.models.fields.IntegerField')())
