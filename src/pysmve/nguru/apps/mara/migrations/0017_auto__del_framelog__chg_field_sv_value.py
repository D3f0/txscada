...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SV.value'
        db.alter_column('mara_sv', 'value', self.gf('django.db.models.fields.IntegerField')())
    ...
    def backwards(self, orm):
        ...
        # Changing field 'SV.value'
        db.alter_column('mara_sv', 'value', self.gf('django.db.models.fields.SmallIntegerField')())
