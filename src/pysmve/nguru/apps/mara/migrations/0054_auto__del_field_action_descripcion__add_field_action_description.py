...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Action.descripcion'
        db.delete_column('mara_action', 'descripcion')

        # Adding field 'Action.description'
        db.add_column('mara_action', 'description',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Action.descripcion'
        db.add_column('mara_action', 'descripcion',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50),
                      keep_default=False)

        # Deleting field 'Action.description'
        db.delete_column('mara_action', 'description')
