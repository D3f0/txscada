...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Event.subsecond'
        db.delete_column('mara_event', 'subsecond')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Event.subsecond'
        raise RuntimeError("Cannot reverse this migration. 'Event.subsecond' and its values cannot be restored.")
