...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EventKind.idtextoev2'
        db.add_column('mara_eventkind', 'idtextoev2',
                      self.gf('django.db.models.fields.IntegerField')(default=None),
                      keep_default=False)

        # Removing M2M table for field di on 'EventKind'
        db.delete_table('mara_eventkind_di')

        # Adding unique constraint on 'EventKind', fields ['idtextoev2', 'value']
        db.create_unique('mara_eventkind', ['idtextoev2', 'value'])


    def backwards(self, orm):
        # Removing unique constraint on 'EventKind', fields ['idtextoev2', 'value']
        db.delete_unique('mara_eventkind', ['idtextoev2', 'value'])

        # Deleting field 'EventKind.idtextoev2'
        db.delete_column('mara_eventkind', 'idtextoev2')

        # Adding M2M table for field di on 'EventKind'
        db.create_table('mara_eventkind_di', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('eventkind', models.ForeignKey(orm['mara.eventkind'], null=False)),
            ('di', models.ForeignKey(orm['mara.di'], null=False))
        ))
        db.create_unique('mara_eventkind_di', ['eventkind_id', 'di_id'])
