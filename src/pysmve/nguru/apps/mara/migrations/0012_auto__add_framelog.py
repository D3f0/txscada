...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FrameLog'
        db.create_table('mara_framelog', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('raw_buff', self.gf('django.db.models.fields.TextField')()),
            ('payload', self.gf('jsonfield.fields.JSONField')(null=True, blank=True)),
            ('date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('profile', self.gf('django.db.models.fields.related.ForeignKey')(related_name='logs', to=orm['mara.Profile'])),
        ))
        db.send_create_signal('mara', ['FrameLog'])


    def backwards(self, orm):
        # Deleting model 'FrameLog'
        db.delete_table('mara_framelog')
    ...
    models = {
        ...
        'mara.framelog': {
            ...
            'raw_buff': ('django.db.models.fields.TextField', [], {})
        },
        'mara.ied': {
