...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ComEventKind.texto_2'
        db.delete_column('com', 'texto_2')

        # Adding field 'ComEventKind.text2'
        db.add_column('com', 'text2',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'ComEventKind.description'
        db.add_column('com', 'description',
    ...
    def backwards(self, orm):
        ...
        # Adding field 'ComEventKind.texto_2'
        db.add_column('com', 'texto_2',
                      self.gf('django.db.models.fields.IntegerField')(default=''),
                      keep_default=False)

        # Deleting field 'ComEventKind.text2'
        db.delete_column('com', 'text2')
    ...
    models = {
        ...
        'mara.comeventkind': {
            ...
            'text2': ('django.db.models.fields.IntegerField', [], {})
        },
        'mara.di': {
