...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'COMaster.custom_payload'
        db.add_column('mara_comaster', 'custom_payload',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'COMaster.custom_payload_enabled'
        db.add_column('mara_comaster', 'custom_payload_enabled',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'COMaster.custom_payload'
        db.delete_column('mara_comaster', 'custom_payload')

        # Deleting field 'COMaster.custom_payload_enabled'
        db.delete_column('mara_comaster', 'custom_payload_enabled')
