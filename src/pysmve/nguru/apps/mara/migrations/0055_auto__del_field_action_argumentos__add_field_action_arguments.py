...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Action.argumentos'
        db.delete_column('mara_action', 'argumentos')

        # Adding field 'Action.arguments'
        db.add_column('mara_action', 'arguments',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Action.argumentos'
        raise RuntimeError("Cannot reverse this migration. 'Action.argumentos' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Action.argumentos'
        db.add_column('mara_action', 'argumentos',
                      self.gf('django.db.models.fields.CharField')(max_length=50),
                      keep_default=False)

        # Deleting field 'Action.arguments'
        db.delete_column('mara_action', 'arguments')
