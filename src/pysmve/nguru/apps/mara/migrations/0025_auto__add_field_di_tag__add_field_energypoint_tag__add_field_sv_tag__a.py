...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DI.tag'
        db.add_column('mara_di', 'tag',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=16),
                      keep_default=False)

        # Adding field 'EnergyPoint.tag'
        db.add_column('mara_energypoint', 'tag',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=16),
                      keep_default=False)

        # Adding field 'SV.tag'
        db.add_column('mara_sv', 'tag',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=16),
                      keep_default=False)

        # Adding field 'AI.tag'
        db.add_column('mara_ai', 'tag',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=16),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DI.tag'
        db.delete_column('mara_di', 'tag')

        # Deleting field 'EnergyPoint.tag'
        db.delete_column('mara_energypoint', 'tag')

        # Deleting field 'SV.tag'
        db.delete_column('mara_sv', 'tag')

        # Deleting field 'AI.tag'
        db.delete_column('mara_ai', 'tag')
