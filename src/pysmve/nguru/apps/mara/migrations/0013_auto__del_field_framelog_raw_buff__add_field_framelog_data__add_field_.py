...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'FrameLog.raw_buff'
        db.delete_column('mara_framelog', 'raw_buff')

        # Adding field 'FrameLog.data'
        db.add_column('mara_framelog', 'data',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

        # Adding field 'FrameLog.source'
        db.add_column('mara_framelog', 'source',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'FrameLog.raw_buff'
        raise RuntimeError("Cannot reverse this migration. 'FrameLog.raw_buff' and its values cannot be restored.")
        # Deleting field 'FrameLog.data'
        db.delete_column('mara_framelog', 'data')

        # Deleting field 'FrameLog.source'
        db.delete_column('mara_framelog', 'source')
