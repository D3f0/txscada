...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'IED', fields ['rs485_address', 'co_master']
        db.create_unique('mara_ied', ['rs485_address', 'co_master_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'IED', fields ['rs485_address', 'co_master']
        db.delete_unique('mara_ied', ['rs485_address', 'co_master_id'])
