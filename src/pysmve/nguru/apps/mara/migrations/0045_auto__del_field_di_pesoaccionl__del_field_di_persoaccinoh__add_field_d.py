...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DI.persoaccion_h'
        db.add_column('mara_di', 'persoaccion_h',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'DI.pesoaccion_l'
        db.add_column('mara_di', 'pesoaccion_l',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'DI.persoaccion_h'
        db.delete_column('mara_di', 'persoaccion_h')

        # Deleting field 'DI.pesoaccion_l'
        db.delete_column('mara_di', 'pesoaccion_l')
    ...
    models = {
        ...
        'mara.di': {
            ...
            'offset': ('django.db.models.fields.SmallIntegerField', [], {'default': '0'}),
            'param': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            'persoaccion_h': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
