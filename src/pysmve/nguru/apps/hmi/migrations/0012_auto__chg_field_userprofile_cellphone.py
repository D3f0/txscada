...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProfile.cellphone'
        db.alter_column('hmi_userprofile', 'cellphone', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

    def backwards(self, orm):

        # Changing field 'UserProfile.cellphone'
        db.alter_column('hmi_userprofile', 'cellphone', self.gf('django.db.models.fields.CharField')(default=None, max_length=20))
