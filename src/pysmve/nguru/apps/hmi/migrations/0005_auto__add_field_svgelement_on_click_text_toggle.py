...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SVGElement.on_click_text_toggle'
        db.add_column('hmi_svgelement', 'on_click_text_toggle',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SVGElement.on_click_text_toggle'
        db.delete_column('hmi_svgelement', 'on_click_text_toggle')
