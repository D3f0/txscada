...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SVGElement.last_update'
        db.alter_column('hmi_svgelement', 'last_update', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'SVGElement.last_update'
        db.alter_column('hmi_svgelement', 'last_update', self.gf('django.db.models.fields.DateField')(null=True))
