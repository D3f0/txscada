...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Formula.target'
        db.add_column('hmi_formula', 'target',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['hmi.SVGElement'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'SVGElement.screen'
        db.add_column('hmi_svgelement', 'screen',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['hmi.SVGScreen'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Formula.target'
        db.delete_column('hmi_formula', 'target_id')

        # Deleting field 'SVGElement.screen'
        db.delete_column('hmi_svgelement', 'screen_id')
