...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SVGElement.linked_text_change'
        db.add_column('hmi_svgelement', 'linked_text_change',
                      self.gf('django.db.models.fields.CharField')(max_length=12, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SVGElement.linked_text_change'
        db.delete_column('hmi_svgelement', 'linked_text_change')
