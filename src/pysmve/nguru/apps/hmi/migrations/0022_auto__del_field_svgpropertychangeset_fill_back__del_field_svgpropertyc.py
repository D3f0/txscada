...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SVGPropertyChangeSet.fill'
        db.add_column('color', 'fill',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='fills', null=True, to=orm['hmi.Color']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'SVGPropertyChangeSet.fill'
        db.delete_column('color', 'fill_id')
    ...
    models = {
        ...
        'hmi.svgpropertychangeset': {
            ...
            'fill': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'fills'", 'null': 'True', 'to': "orm['hmi.Color']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
